...
Finally, note that the provided visualization tools are not exhaustive. There may be other things that are useful to visualize when developing your planning and pursuit code! Apply the experimental robotics skills you've acquired in previous labs to formulate a set of tasks in TESSE which demonstrate your system's capabilities and limitations to their fullest extent.
